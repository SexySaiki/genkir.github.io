...
compiler(){
	...
	if   [[ ! -z "${ver_4_16}" ]]; then
		wget --no-check-certificate https://raw.githubusercontent.com/tcp-nanqinlang/general/master/General/Debian/source/kernel-v4.16/tcp_nanqinlang.c
	elif [[ ! -z "${ver_4_15}" ]]; then
		wget --no-check-certificate https://raw.githubusercontent.com/tcp-nanqinlang/general/master/General/Debian/source/kernel-v4.15/tcp_nanqinlang.c
	elif [[ ! -z "${ver_4_14}" ]]; then
		wget --no-check-certificate https://raw.githubusercontent.com/tcp-nanqinlang/general/master/General/Debian/source/kernel-v4.14/tcp_nanqinlang.c
	elif [[ ! -z "${ver_4_13}" ]]; then
		wget --no-check-certificate https://raw.githubusercontent.com/tcp-nanqinlang/general/master/General/Debian/source/kernel-v4.13/tcp_nanqinlang.c
	else
		wget --no-check-certificate https://raw.githubusercontent.com/tcp-nanqinlang/general/master/General/Debian/source/kernel-v4.12andbelow/tcp_nanqinlang.c
	fi
	...
	if [[ "`grep -oE  "[0-9.]+" /etc/issue`" = "9" ]]; then
		wget --no-check-certificate -O Makefile https://raw.githubusercontent.com/tcp-nanqinlang/general/master/Makefile/Makefile-Debian9
	else
		wget --no-check-certificate -O Makefile https://raw.githubusercontent.com/tcp-nanqinlang/general/master/Makefile/Makefile-Debian7or8
	fi
